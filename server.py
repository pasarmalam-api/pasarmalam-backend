...
ADMIN_APP_URL = os.environ.get("ADMIN_APP_URL", "https://bronze-kally-50.tiiny.site")
...
BUYER_APP_URL = os.environ.get("BUYER_APP_URL", "https://gray-benedetta-20.tiiny.site")
