(function(){
  ...
  function injectCss(){
    ...
    style.textContent=[
      ...
      "@media(max-width:760px){.pm-live-alert:not(.landing){position:static;left:auto;right:auto;bottom:auto;z-index:1;margin:10px 12px;max-width:none;transform:none;opacity:1;pointer-events:auto;box-shadow:0 8px 18px rgba(16,24,40,.14)}.pm-notify-enable{position:static;display:block;width:calc(100% - 24px);max-width:520px;margin:12px auto 18px;z-index:1;min-height:40px;border-radius:8px;box-shadow:0 8px 18px rgba(226,27,112,.18)}}",
      "@media(max-width:760px){.pm-live-alert.landing{grid-template-columns:auto 1fr;margin:8px 0 10px;padding:10px;gap:8px;border-radius:8px;box-shadow:0 8px 18px rgba(16,24,40,.14)}.pm-live-alert.landing .pm-live-bell{width:32px;height:32px;font-size:17px}.pm-live-alert.landing .pm-live-title{font-size:13px}.pm-live-alert.landing .pm-live-body{font-size:11.5px;line-height:1.24}.pm-live-alert.landing .pm-live-action{grid-column:1/-1;width:100%;min-height:32px;font-size:11.5px}}",
      "@media(max-width:420px){.pm-live-alert{grid-template-columns:auto 1fr}.pm-live-action{grid-column:1/-1;width:100%}.pm-live-title{font-size:13px}.pm-live-body{font-size:11.5px}.pm-notify-enable{min-height:38px;font-size:11px}.pm-live-alert.landing{padding:9px}.pm-live-alert.landing .pm-live-action{min-height:31px}}"
    ].join("");
