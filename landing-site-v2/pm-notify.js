(function(){
  ...
  function injectCss(){
    ...
    style.textContent=[
      ...
      "@media(max-width:760px){.pm-live-alert.landing{margin:8px 0 10px;padding:10px;gap:8px;border-radius:8px;box-shadow:0 8px 18px rgba(16,24,40,.14)}.pm-live-alert.landing .pm-live-bell{width:32px;height:32px;font-size:17px}.pm-live-alert.landing .pm-live-title{font-size:13px}.pm-live-alert.landing .pm-live-body{font-size:11.5px;line-height:1.24}.pm-live-alert.landing .pm-live-action{min-height:32px;font-size:11.5px}}",
