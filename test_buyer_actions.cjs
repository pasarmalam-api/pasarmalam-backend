...
(async()=>{
 ...
 await go('orders.html');await text('#orders','PM-1');await page.locator('#orders a[href="order-detail.html?id=1"]').click();await page.waitForURL('**/order-detail.html?id=1');await page.locator('.buyer-back').click();await page.waitForURL('**/orders.html');
